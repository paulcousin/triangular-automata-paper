...
\noindent There are a few rules where the state of the first alive cell evolves in an interesting way. This succession of states forms the center column of the space-time plots.
\vspace{40pt}
...
Rule 210 is easy to describe: ``change the state of cells who have one neighbor alive". It is special for several reasons. It makes structures at larger scales as time goes on and a new type of structure emerges around $t=1024$.
...
\begin{table}[H]
    ...
    \end{tblr}
    \caption{Evolution of rule 210}
    \label{tab:rule-210-evolution}
\end{table}

\begin{figure}[H]
    \centering
    \includegraphics[width=.85\textwidth]{graphics/behavior/rule-210/rule-210-time-4097-small.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{graphics/behavior/rule-210/rule-210-time-2048-close-up-3.jpg}
    \vspace{-16pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{graphics/behavior/rule-210/rule-210-time-4096-close-up-2.jpg}
    \vspace{-16pt}
    \caption{Close-up of rule 210 at $t=4096$}
    \label{fig:rule-210-close-up-4096}
\end{figure}

\noindent Rule 210 initially alternates between what seems like 2 population densities (i.e. number of alive cells / size of the region of influence of the first cell). When the new structure appears, around $t=1024$, the population stabilizes into a density cycle of period 4 between slowly evolving values.
