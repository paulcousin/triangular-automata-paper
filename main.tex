...
\usepackage{pifont}
\usepackage{xcolor}
\definecolor{Alive}{rgb}{0.5, 0, 0.5}
\definecolor{Dead}{rgb}{1, 0.5, 0}
...
\begin{figure}[H]
    ...
    \caption{Space-time plot of rule 10 up to $t=512$ (perspective)}
...
\begin{table}[H]
    ...
    \begin{tblr}{|Q[c,m]|Q[c,h]|Q[c,h]|Q[c,h]|Q[c,h]|}
        ...
        \hline
            ...
            \raisebox{-.05\height}{\includegraphics[width=0.19\textwidth]{graphics/behavior/self-reproduction/rule-170-time-112.pdf}} \\
        \hline
    \end{tblr}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.66\textwidth]{graphics/behavior/textures/rule-204-time-32-noise.pdf}
    \caption{Rule 204 at at $t=32$ starting from \textit{Figure \ref{fig:rule-37-time-512-asymmetric}}}
    \label{fig:rule-204-time-32-noise}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=.66\textwidth]{graphics/behavior/textures/rule-252-time-32-noise.pdf}
    \caption{Rule 252 at at $t=32$ starting from \textit{Figure \ref{fig:rule-37-time-512-asymmetric}}}
    \label{fig:rule-252-time-32-noise}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=.72\textwidth]{graphics/behavior/textures/rule-100-time-64-noise.pdf}
    \caption{Rule 100 at at $t=64$ starting from \textit{Figure \ref{fig:rule-37-time-512-asymmetric}}}
    \label{fig:rule-100-time-64-noise}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=.72\textwidth]{graphics/behavior/textures/rule-108-time-512-noise.pdf}
    \caption{Rule 108 at at $t=512$ starting from \textit{Figure \ref{fig:rule-37-time-512-asymmetric}}}
...
\begin{enumerate}
    ...
    \item[•] It is useful here to be able to retrieve the number of layers in the graph, just by knowing its order. 
 \begin{equation}
 layer=\frac{1}{6}\Big(\sqrt{3(8\,order-5)}-3\Big)
 \end{equation}
